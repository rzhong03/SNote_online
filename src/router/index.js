...
export const currencyRoutes = [
    ...
    children: [
      {
        ...
        meta: { title: 'Home', icon: 'el-icon-s-data' }
      }
    ]
  },
  {
    ...
    // 最新文档
  {
    ...
    component: Layout,
    name: 'Latest-doc',
    redirect: '/Latest-doc/index',
    children: [
      {
        path: 'index',
        name: 'Latest-doc-index',
        component: () => import('@/views/Latest-doc'),
        meta: { title: 'Latest', icon: 'el-icon-document' }
      }
    ]
  },
    //笔记本
    ...
    children: [
      {
        ...
        meta: { title: 'Notebook', icon: 'el-icon-mobile-phone' }
      }
    ]
  },
    //删除
    ...
    children: [
      {
        ...
        meta: { title: 'Delete', icon: 'el-icon-delete' }
      }
    ]
  },
    //导航
    ...
    children: [
      {
        ...
        meta: { title: 'Guide', icon: 'el-icon-s-flag' }
      }
    ]
  }
]
